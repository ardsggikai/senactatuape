...
echo -e "Após a instalação do Webmin acessar a URL: https://$(hostname -I | cut -d' ' -f1):$PORTWEBMIN/"
echo -e "Após a instalação do Usermin acessar a URL: https://$(hostname -I | cut -d' ' -f1):$PORTUSERMIN/\n"
