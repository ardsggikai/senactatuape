...
public class Boletim extends JFrame {
	...
	public Boletim() {
		...
		JLabel lblº1bimestre = new JLabel("1\u00BA Bimestre");
		lblº1bimestre.setFont(new Font("Arial", Font.PLAIN, 11));
		lblº1bimestre.setBounds(20, 140, 78, 14);
		contentPane.add(lblº1bimestre);

		JLabel lblº3bimestre = new JLabel("3\u00BA Bimestre");
		lblº3bimestre.setFont(new Font("Arial", Font.PLAIN, 11));
		lblº3bimestre.setBounds(214, 140, 78, 14);
		contentPane.add(lblº3bimestre);

		JLabel lblº2bimestre = new JLabel("2\u00BA Bimestre");
		lblº2bimestre.setFont(new Font("Arial", Font.PLAIN, 11));
		lblº2bimestre.setBounds(20, 190, 78, 14);
		contentPane.add(lblº2bimestre);

		JLabel lblº4bimestre = new JLabel("4\u00BA Bimestre");
		lblº4bimestre.setFont(new Font("Arial", Font.PLAIN, 11));
		lblº4bimestre.setBounds(214, 190, 78, 14);
		contentPane.add(lblº4bimestre);
