...
public class Hora extends JDialog {
	...
	void Salvar() {
		...
		} else if (txtTempoEstimado.getText().isEmpty()) {
			JOptionPane.showMessageDialog(null, "Preencha o Estimativa de Horas do ServiÁo:");
	...
	// Estimativa de Horas do Servi√ßo:
	// Metodo usado para calcular o valor do servi√ßo
	void calcularServico() {
		...
		// Saida
		JOptionPane.showMessageDialog(null, "Valor do Servi√ßo √© $ " + valor, "Relatorio", JOptionPane.DEFAULT_OPTION);
	}
}// Fim do Codigo
