...
public class Hora extends JDialog {
	...
	public Hora() {
		...
		RestrictedTextField validar4 = new RestrictedTextField(txtRendimento, "1234567890.");
	...
	void Salvar() {
		...
		if (txtRemuneracao.getText().isEmpty()) {
			...
			JOptionPane.showMessageDialog(null, "Preencha o Estimativa de Horas do Servi�o:");
