...
public class Portfolio extends JFrame {
	...
	public Portfolio() {
		...
		JButton btnNewButton = new JButton("Calculo do IMC");
		...
		btnNewButton.setBounds(573, 85, 160, 23);
		...
		btnNewButton_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				// as linhas abaixo fazem o link com o formul�rio Sobre
				Sobre sobre = new Sobre ();
				sobre.setVisible(true);
			}
		});
		btnNewButton_1.setBounds(360, 29, 89, 23);
