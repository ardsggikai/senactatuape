...
public class Portfolio extends JFrame {
	...
	public Portfolio() {
		...
		btnBotaodoimc.setBounds(640, 11, 64, 64);
		...
		btnSobre.setBounds(740, 386, 64, 64);
		...
		btnFichaAluno.setBounds(10, 11, 64, 64);
		...
		btnBoletim.setBounds(10, 86, 64, 64);
		...
		btnCalculoDoTemperatura.setBounds(640, 86, 64, 64);
		...
		btnCalculoDePorcentagem.setBounds(640, 161, 64, 64);
		...
		btnCalculoDeHora.setBounds(640, 236, 64, 64);
		...
		btnEtanolGasolina.setBounds(640, 311, 64, 64);
		...
		btnEleitor.setBounds(110, 11, 64, 64);
