...
public class Array2 {
	...
	public static void main(String[] args) {
		...
		/**
		 * for (int i = 0; i < faces.length; i++) { for (int j = 0; j < naipes.length;
		 * j++) { System.out.println(faces[i] + naipes[j]); } }
		 **/
		System.out.println("===========================");
		...
		/***************************************************************************************************************
		 **** CRIAR UMA VARIAVEL DO TIPO INTEIRO QUE RECEBE UM NUMERO ALEATORIO ENTRE 0 E O
