...
public class Moeda extends JDialog {
	...
	public Moeda() {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(Moeda.class.getResource("/img/icoMoeda.png")));
		...
		btnCalcular.setIcon(new ImageIcon(Moeda.class.getResource("/img/btnCalcular.png")));
		...
		btnCalcular.setBounds(32, 115, 64, 64);
		...
		btnLimpar.setIcon(new ImageIcon(Moeda.class.getResource("/img/eraser.png")));
		...
		btnLimpar.setBounds(147, 115, 64, 64);
